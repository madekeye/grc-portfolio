...
|------------------------------------------------|---------------------------|-------------------------------------|
| [Network Traffic Analysis Using Wireshark](./https://github.com/madekeye/grc-portfolio/case-studies/network_traffic_analysis.md) | Network Forensics         | Wireshark, VirusTotal, Python      |
